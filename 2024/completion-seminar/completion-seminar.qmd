...
format: 
  beamer: 
    ...
    header-includes: |
      ...
      \fill[right color=white, left color=blue!5] 
...
-   Recent studies show optimal QAOA parameters for depth $p$ are \alert{transferable} across typical instances [@Brandao2018]
...
\begin{tcolorbox}[
    ...
    boxrule=1pt,
    arc=3mm,
    title={\large\textbf{Research Question}},
...
\large
How do problem instance characteristics influence the key design decisions of the QAOA and its performance, \textbf{and} can we develop methods to automatically select optimal parameters based on these characteristics to improve QAOA's performance on diverse MaxCut instances?
\end{tcolorbox}
...
-   **Benefits of instance-based approaches?**
    - Reduces calls to quantum devices \rightarrow  *less resource use*
    
:::

::: {.column width="55%"}

![Optimisation Landscape for various instances of unweighted MaxCut](images/optimisation-landscape.png)
...
### Instance Space Analysis [@smith2023instance]
...
::: {.content-center}
![Instance space analysis workflow](images/isa.pdf){height=84% fig-align="center"}
:::
...
\vspace{0.3cm}
{\large \textbf{Total Network Classes:} $7 \times 6 = 42$}
\end{center}
...
\textcolor{gray}{\rule{0.8\textwidth}{0.4pt}}
\vspace{0.2cm}
{\small \textbf{Total Features:} 48 graph characteristics across 5 categories}
\end{center}
